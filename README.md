...
Download the current install ZIP from the repository's
[Releases](https://github.com/lesogorp/NERC-Goosky-FlightDeck/releases) page.
...
The installable SD-card tree is under [`SDCARD`](SDCARD). Automated EdgeTX
mocks, simulator instructions, and the release builder are included for future
work:

- [Development workflow](DEVELOPMENT.md)
- [Testing and simulator guide](TESTING.md)
- [Change history](CHANGELOG.md)

Run `lua tests/run_tests.lua` or the default VS Code test task before creating
a pull request. GitHub Actions repeats the tests and builds an install ZIP for
